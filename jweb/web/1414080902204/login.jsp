...
/* function validate(){
		...
		var checknumber=document.forms[0].CheckNumber.value;
		 if(cardnumber.length!=10) window.alert("深圳通必须为10位号码");
	...
	<center>
		...
		<table width="100%" padding=0>
			...
			<tr>
				...
				<td><input type="text"  class="form-control" name="kahao" required="true"  placeholder="请输入10位深圳通卡号"></td>
			
			</tr>
			<tr>
				<td align="right">手机号码  &nbsp;</span> </td>
				<td><input  type="text" name="shoujihao"  required="true" class="form-control" placeholder="请输入11位手机号码"></td>&nbsp;
		...
		<div align="center">
		<input type="submit" class="btn btn-primary" id="ss" value="登陆" >	
