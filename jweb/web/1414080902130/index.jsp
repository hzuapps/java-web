...
<form role="form" class="form-horizontal" action="Check" method="get">
    ...
    <div class="form-group">
            ...
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">GC-高铁
            </label>
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">D-动车
            </label>
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">Z-直达
            </label>
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">T-特快
            </label>
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">K-快速
            </label>
            <label class="control-label col-md-1">
                <input type="checkbox" name="train">其它
            </label>
    </div><br>

    <div class="form-group">
        <label class="control-label col-md-1">优先席别</label>
        <label class="control-label col-md-1">
            <input type="checkbox" name="seat">商务座
        </label>
        <label class="control-label col-md-1">
            <input type="checkbox" name="seat">一等座
        </label>
        <label class="control-label col-md-1">
            <input type="checkbox" name="seat">二等座
        </label>
        <label class="control-label col-md-1">
            <input type="checkbox" name="seat">无座
        </label>
    </div><br><br>
